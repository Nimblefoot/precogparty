...
import TakeExitOrder, { useSellable } from "./TakeExitOrder"

const TakeOrderPanel = ({ marketAddress }: { marketAddress: PublicKey }) => {
  ...
  return (
    <div>
      <div className="shadow bg-white rounded-lg">
        ...
        <div className={clsx("flex flex-col", mode === "buy" ? "" : "hidden")}>
          <TakeOrderPanel marketAddress={marketAddress} />
        </div>
        <div className={mode === "sell" ? "" : "hidden"}>
          <TakeExitOrder marketAddress={marketAddress} />
        </div>
      </div>
    </div>
  )
